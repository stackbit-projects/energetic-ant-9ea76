...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9ea769d5cc90015f53c25
...
To start editing your site, you can use the Sanity interface at https://energetic-ant-9ea76.sanity.studio/.
...
Generated at `2020-12-28T14:24:33.736Z` by Stackbit version `0.3.41`.